...
W='\033[0m'
# The Credit For This Code Goes To dpmods And All Other Contributors Listed At https://github.com/TheSpeedX/TBomb
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update casm')
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To ypiyush218@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By dpmods !!                ")
        print("==================================================================")
        try:
